package com.techease.grubsup.utils;
...
public class GetLocation {
    ...
    public void getLocation(Context context) {
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions((NavigationTabActivity) context, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
            ...
            GeneralUtills.putStringValueInEditor(context, "latitude", strLatitude);
            GeneralUtills.putStringValueInEditor(context, "longitude", strLongitude);
        }
    }
